    ...
    <section className="py-24 bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#0F172A] tracking-tight">
            {language === 'ID'
              ...
              : 'What They Said After the Project Shipped'}
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((t) => {
            const roleText =
              t.role === 'Pengembang Penilaian Pendidikan Ahli Muda'
                ? language === 'EN'
                  ? 'Education Assessment Developer'
                  : 'Pengembang Penilaian Pendidikan Ahli Muda'
                : t.role;
            const companyText =
              t.company === 'PUSMENDIK, KEMENDIKBUDRISTEK'
                ? language === 'EN'
                  ? 'Pusmendik, Ministry of Education (Kemendikbudristek)'
                  : 'PUSMENDIK, KEMENDIKBUDRISTEK'
                : t.company;
                ...
                <div className="flex items-center gap-4 pt-6 border-t border-slate-100">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-semibold text-slate-500">
                      {roleText} • <span className="text-[#1793E8] font-bold">{companyText}</span>
                    </p>
                  </div>
                </div>
              </div>
